        ...
        <div class="local">
                ...
                <div class="col col-huyen">
                    ...
                    <img  src="../img/phanthiet.jpg" class="card-img-top " alt="phanthiet">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Tour Phan Thiết 3N2D: HCM - Núi Tà Cú - Hải Đăng Kê Gà - Dinh Thầy Thím </h5>
                            <p class="card-text">
                            <div class="row">
                                <div class="col-md-2 score">10</div>
                                <div class="col-md-4 score-des">Tuyệt vời</div>
                ...
                <div class="col col-huyen">
                    <div class="card" style="width: 22rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                            <div class="row">
                                <div class="col-md-2 score">9.7</div>
...
>>>>>>> 5f3ea1e55196a1163a4f3efc21e495df4c00b332
